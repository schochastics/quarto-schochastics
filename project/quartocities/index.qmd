...
![](hot.gif)![](hot.gif)![](hot.gif)![](hot.gif)![](hot.gif)  

![](hot.gif)Check out the
[demo](https://schochastics.quarto.pub/quartocities)  ![](hot.gif)  
...
<a href="https://twitter.com/schochastics"><img src="twitter.gif"></a>
<a href="https://github.com/schochastics"><img src="hacker.gif"></a>
...
![](mchammer.gif)![](mchammer.gif)![](mchammer.gif)
...
`microfab`. other options can be found in the `bg` folder (dont use the file
...
gif. The gif needs to be present in the `` folder (dont use the file ending,
